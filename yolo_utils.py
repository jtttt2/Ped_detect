...
def get_training_data(annotation_path, data_path, input_shape, anchors, num_classes, max_boxes=14, load_previous=True):
    """
    ...
    with open(annotation_path) as f:
        ...
        for line in (GG):
            ...
            image_data.append(np.array(image, dtype=np.uint8))  # pixel: [0:255] uint8:[-128, 127]
            image_shape.append(np.array(image.size))
